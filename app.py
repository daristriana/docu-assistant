...
from langchain.chains import create_retrieval_chain # <-- Corregido
        ...
        with st.chat_message("ai"):
            with st.spinner("Searching the documentation..."):
                try:
                    ...
                    # 
                    conversational_rag_chain = create_retrieval_chain( # <-- TYPO 1 FIXED
                    ...
                    st.error(error_msg)
                    st.session_state.messages.append(AIMessage(content=error_msg)) # <-- TYPO 2 FIXED
